  ...
  return (
    <div className="About">
      ...
      <section className="desc">
        <h1 className="alt-font">Sukoon Resort Phuket</h1>
        <span></span>
      ...
      <section className="testimonials">
          ...
          <div className="quote-container">
            <p>
              <em>
                ...
                to try the Sukoon Resort. We were totally refreshed and
        ...
        <article className="testimonials-card reversed">
          ...
          <div className="quote-container">
            <p>
              <em>
                "We had been guests at the Sukoon Resort last weekend and we have
