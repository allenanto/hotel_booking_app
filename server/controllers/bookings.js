...
const { generateID, deleteExpiredBookings } = require("./helper.js");
...
var transport = nodemailer.createTransport({
  ...
  port: 587,
  auth: {
    user: 'allenantony26@gmail.com',
    pass: 'mfgi hglq icqk ajnn'
  }
});
...
module.exports.postBooking = async (req, res) => {
  try {
    ...
    const mailOptions = {
      ...
      html: `<h3>Your resort booking from ${dates[0]} to ${dates[1]} is confirmed successfully!!!</h3><h3>Confirmation Code: ${newId}</h3>`
    };
